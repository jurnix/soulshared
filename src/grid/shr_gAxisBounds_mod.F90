...
module shr_gAxisBounds_mod
  ...
  public :: shr_gAxisBounds

  logical, parameter :: ISDEBUG = .false.


  type shr_gAxisBounds
...
contains
  ...
  subroutine gGridAxesBounds_initialize(self, startCoord, endCoord)
    ...
    !< startCoord > endCoord
    class(shr_gAxisBounds), intent(inout) :: self
    real(kind=sp), intent(in) :: startCoord, endCoord 

    if (startCoord <= endCoord) then
      write(*,*) "shr_gAxisBounds_mod:: gGridAxesBounds_initialize:: startCoord, endCoord =", &
            startCoord, endCoord
  ...
  elemental logical function isInByCoord(self, axisCoord) result (isIn)
    ...
    class(shr_gAxisBounds), intent(in) :: self
  ...
  elemental logical function isInByGridAxesBounds(self, gridAxesBounds) result (isIn)
    ...
    class(shr_gAxisBounds), intent(in) :: self
    type(shr_gAxisBounds), intent(in) :: gridAxesBounds
  ...
  elemental logical function equal_gGridAxesBounds(self, other)
    ...
    class(shr_gAxisBounds), intent(in) :: self
    type(shr_gAxisBounds), intent(in) :: other
  ...
  elemental type(shr_gridBounds) function create_gridBounds(latBounds, lonBounds) result (newGb)
    ...
    class(shr_gAxisBounds), intent(in) :: latBounds
    type(shr_gAxisBounds), intent(in) :: lonBounds
...
end module shr_gAxisBounds_mod
